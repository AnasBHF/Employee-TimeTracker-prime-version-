...
export function History() {
  ...
  const lateArrivals = timeEntries
    .filter(entry =>
      entry.employeeId === user?.id &&
      entry.clockIn &&
      new Date(`1970-01-01T${entry.clockIn}:00`).getHours() >= 9
    )
  ...
  return <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div className="bg-white rounded-lg shadow-md p-6 mt-8">
      <div className="flex items-center mb-4">
        <AlertCircleIcon className="h-6 w-6 text-yellow-600 mr-2" />
    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden mt-8">
      ...
      {sortedEntries.length > 0 ? <div className="max-h-[300px] overflow-y-auto">
        <table className="min-w-full divide-y divide-gray-200">
